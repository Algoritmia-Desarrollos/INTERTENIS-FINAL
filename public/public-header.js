    ...
    <header class="flex items-center justify-between border-b border-gray-700 bg-[#222222] px-4 sm:px-6 py-3 sticky top-0 z-50">
      ...
      <div class="flex-1 flex justify-center">
        <div class="relative w-full max-w-xs">
          ...
          <input type="text" id="player-search-input" class="input-field !pl-10 w-full" placeholder="Escribe el nombre de un jugador..." autocomplete="off">
      ...
      <a href="/src/admin/login.html" class="text-sm font-medium text-gray-300 hover:text-yellow-400 flex items-center gap-2 ml-4">
