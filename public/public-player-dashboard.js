        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-700">
                                ...
                                }).join('') : '<tr><td colspan="4" class="text-center p-4 text-gray-400">No hay partidos.</td></tr>'}
                            </tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="bg-[#222222] p-6 rounded-xl shadow-lg">
                ...
                <div class="space-y-4">
                    ...
                    `).join('') : '<p class="text-center text-sm text-gray-400 py-4">No está inscrito en torneos.</p>'}
                </div>
            </div>
        </div>
    `;
