// Ruta NUEVA: src/common/components/matchesTable.js
// Este módulo centraliza la lógica de renderizado de la tabla de historial/partidos
// que se usa en los dashboards de jugador (admin, public y portal).

// Usamos la ruta absoluta para asegurar que se encuentre
...
/**
 * Renderiza la tabla de historial de partidos en un contenedor específico.
 * (Función extraída de public-player-dashboard.js y admin-player-dashboard.js)
 * @export
 */
export function renderMatchesTable(matchesToRender, containerElement, emptyMessage) {
